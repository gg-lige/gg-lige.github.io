...
> 正所谓前人栽树，后人乘凉。
> 
> 感谢[Huxpro](https://github.com/huxpro)提供的博客模板和[BY Blog](https://github.com/qiubaiying)提供的博客搭建方法。
> 
> [我的的博客](http://gg-lige.github.io)

# 前言
从 Jekyll 到 GitHub Pages 按照BY的搭建过程进行，终于把我的个人博客[GG Blog](http://gg-lige.github.io)搭建出来了。
以下为BY博客内容。
